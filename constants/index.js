...
export const projects = [
    {
    id: 1,
    title: "The Silk Shake - Frontend Website",
    description:
      "A visually stunning frontend website for The Silk Shake, built with React, Tailwind CSS, and GSAP for smooth animations. The site features a responsive design, interactive elements, and a modern aesthetic to showcase the brand's products and story.",
    category: "Frontend",
    type: "Web App",
    link: "https://github.com/Anup9148680234/thesilkshake",
    image: "/mocks/thesilkshake.gif",
