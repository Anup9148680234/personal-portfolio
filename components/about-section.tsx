      ...
      <section id="about" className="min-h-screen flex items-center py-20">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            I'm Anup, an Electronics and Communication graduate who found his passion in building for the web. I enjoy crafting clean, scalable, and user-focused web applications, turning complex ideas into smooth digital experiences.
            <br/>
            <br />
With hands-on experience in JavaScript, the MERN stack, and Shopify, I focus on writing efficient code, building intuitive interfaces, and delivering solutions that actually solve problems. I'm constantly learning, experimenting with modern tools, and pushing myself to build better, faster, and smarter products.</p>
            <button
